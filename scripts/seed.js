...
const seedDatabase = async () => {
  try {
    ...
    console.log('Seeding Users with Indian addresses...');
    const adminUser = await User.create({
      ...
      bio: 'Styleswap - Community Oversight & Verified Pre-Loved Listings.'
    });
    ...
    console.log('Seeding Pre-Loved & Second-Hand Listings in ₹ (Rupees)...');
    const listingsData = [
      {
        sellerId: user1._id,
    ...
    console.log('Seeding Sample Transactions in ₹ Rupees...');
    ...
    await Transaction.create({
      ...
      exchangeItemId: createdListings[0]._id,
      status: TRANSACTION_STATUS.PENDING,
      notes: 'Hey Ananya! Love this sling bag. Would you like to trade it for my thrifted 90s biker jacket?'
    });

    console.log('====================================================');
    console.log('✓ Indian Second-Hand Thrift Marketplace Seeded Successfully!');
    console.log('====================================================');
    console.log('Admin Account: admin@smartware.com / Admin@12345');
    console.log('Thrifter Accounts (Password: User@12345):');
    console.log('  - rohan@thriftfinds.in (Bengaluru)');
    console.log('  - ananya@prelovedwardrobe.in (Mumbai)');
    console.log('  - kabir@streetstyle.in (New Delhi)');
    console.log('====================================================');
